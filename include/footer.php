    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-3">
                ...
                <p>Recruitment and talent solutions partner for IT and Non-IT organizations across India. We make it
                    possible.</p>
                ...
                <form id="hireForm">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="company_name" placeholder="Your Company"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Contact Person</label>
                            <input type="text" class="form-control" name="contact_person" placeholder="HR Manager"
                                required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="upload-zone" id="dropArea">
                                ...
                                <input type="file" id="fileInput" name="cv_file" hidden accept=".pdf,.doc,.docx"
                                    required>
                                <!-- File Preview -->
...
<script>
    ...
    // Generates 1 to 35 local images automatically
